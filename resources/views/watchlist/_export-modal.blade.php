            ...
            <form id="exportForm" class="p-6 sm:p-8 space-y-6">
                ...
                <div>
                    ...
                    <div class="space-y-3 bg-slate-800/50 p-4 rounded-lg border border-slate-700">
                        ...
                        <label class="flex items-center gap-3 cursor-pointer group">
                            <input type="checkbox" name="filters[watching]" value="1" checked class="w-5 h-5 rounded bg-slate-700 border-slate-600 text-amber-500 cursor-pointer">
                            <span class="text-slate-200 group-hover:text-white transition">🎬 En train de voir</span>
                        </label>
                        <label class="flex items-center gap-3 cursor-pointer group">
                            <input type="checkbox" name="filters[watched]" value="1" checked class="w-5 h-5 rounded bg-slate-700 border-slate-600 text-green-500 cursor-pointer">
                ...
                <div>
                    ...
                    <div class="space-y-3 bg-slate-800/50 p-4 rounded-lg border border-slate-700">
                        <label class="flex items-center gap-3 cursor-pointer group">
                            <input type="radio" name="locale" value="fr" checked class="w-5 h-5 text-red-500 cursor-pointer">
                            <span class="text-slate-200 group-hover:text-white transition">🇫🇷 Français</span>
                        </label>
                        <label class="flex items-center gap-3 cursor-pointer group">
                            <input type="radio" name="locale" value="en" class="w-5 h-5 text-red-500 cursor-pointer">
                            <span class="text-slate-200 group-hover:text-white transition">🇬🇧 English</span>
                        </label>
                        <label class="flex items-center gap-3 cursor-pointer group">
                            <input type="radio" name="locale" value="de" class="w-5 h-5 text-red-500 cursor-pointer">
